...
import 'dart:convert';
import 'package:sisterservicegui/matakuliah/insertMatakuliah.dart';
import 'package:sisterservicegui/matakuliah/updateMatakuliah.dart';
...
class _DataMatakuliahState extends State<DataMatakuliah> {
  ...
  Future<void> deleteMatakuliah(int id) async {
    String urlMatakuliah = "http://192.168.56.1:9002/api/v1/matkul/${id}";
    try {
